...
const term = 'fall22'
const termSubtitle = 'Fall 2022' // used as text for #semester-subtitle in index.html
...
const startSemesterTime = Date.UTC(2022, 7, 29, 0, 0, 0)

// Change these lol I don't wanna write a scraper rn
const startSemester = ['2022', '08', '29'];
const endSemester = ['2022', '12', '07'];
const endHalfSemester = ['2022', '10', '07'];
